...
<div class="re-app is-schools" data-base="{{ '/assets/realestate' | relative_url }}">
  ...
  <p class="re-caveat">
    ...
    지도에 올리는 중학교는 사립중·국제중뿐입니다. 다만 진학률 열과 비교 차트는
    공립중까지 포함한 서울·경기 중학교 1,050곳을 놓고 계산합니다 — 비슷한 학교를
    고르려면 지도에 없는 학교까지 봐야 하기 때문입니다.
    진학률은 학교알리미 「졸업생의 진로 현황」(연 1회 11월 공시) 최근 3년치이고,
    특목고 소계와 자율고 소계를 합쳐 졸업자 수로 나눈 값입니다.
    졸업생이 30명 미만인 학교는 한 명이 몇 %p씩 값을 흔들어 <b>*</b> 표시를 달았습니다.
  </p>
