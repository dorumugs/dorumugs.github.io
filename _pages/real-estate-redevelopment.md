...
<div class="re-app is-redev" data-base="{{ '/assets/realestate' | relative_url }}">
  ...
  <p class="re-caveat">
    ...
    정렬해서 보도록 했습니다.
    <br><br>
    <b>용적률 상한은 서울 단지에만</b> 붙였습니다. 서울시 도시계획조례 기준(1종 150 ·
    2종 200 · 3종 250 · 준주거 400%)인데, 경기는 시·군마다 조례가 달라 같은 표를 쓰면
    틀립니다. 경기 단지는 용도지역만 보여주고 상한은 비워 뒀습니다. 서울이라도 실제
    정비계획에서는 공공기여·임대주택 등으로 완화되는 경우가 많아, 이 값을 근거로
    분담금이나 사업성을 단정할 수 없습니다.
    <br><br>
