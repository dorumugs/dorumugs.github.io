...
<div class="re-app is-redev" data-base="{{ '/assets/realestate' | relative_url }}">
  ...
  <p class="re-caveat">
    ...
    <br><br>
    <b>세대수와 대지면적</b>은 건축물대장을 먼저 보고, 대장에 대지면적이 없는 단지만 서울시
    도시계획포털의 연속지적도로 메웠습니다. 단지 식별정보는 한 단지를 지번마다 쪼개 등록해
    세대수가 조각나 있는데, 대장의 총괄표제부는 단지 전체를 한 줄로 주기 때문입니다.
    <b>용도지역과 공시지가는 서울만</b> 있습니다 — 지적도에서만 오고 경기도는 이 경로가
    열리지 않습니다.
    <br><br>
