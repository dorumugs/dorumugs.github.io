...
[지난 글](/coding/github-ssh-키-등록-ed25519-한-짝으로-통일하기/)에서 만든 ed25519 키를 그대로 써서   
...
아직 없다면 [GitHub SSH 키 등록 글](/coding/github-ssh-키-등록-ed25519-한-짝으로-통일하기/)에서 `ssh-keygen` 부분만 먼저 따라하고 오시면 돼요. 
