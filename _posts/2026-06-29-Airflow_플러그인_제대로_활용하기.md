---
layout: single
title:  "(1/4) Airflow 플러그인 제대로 활용하기 — Slack/Teams 알람부터 하나의 DAG 멀티 스케줄까지"
...
series: airflow-ops
series_order: 1
series_title: "🛠️ Airflow 운영 확장"
---


{% include series-airflow-ops.html current="1" %}
...
**다음 글 →:** [(2/4) Airflow listener 와 OpenLineage 로 데이터 계보(lineage) 자동 수집하기](/coding/Airflow_listener_OpenLineage_데이터계보/)
