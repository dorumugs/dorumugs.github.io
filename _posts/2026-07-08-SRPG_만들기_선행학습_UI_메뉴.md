---
layout: single
title:  "(8/8) 2D SRPG 만들기 선행학습 — UI 와 메뉴, 정보를 보여주는 기술"
...
이것으로 여덟 편의 선행학습이 진짜로 끝났습니다. 게임 루프에서 시작해 좌표계·스프라이트·길찾기·전투·데이터·맵 에디터를 지나 UI 까지 — 파랜드 택틱스 같은 게임을 이루는 부품을 전부 한 번씩 직접 만들어봤어요. 남은 로드맵(사운드·연출·배포·엔진 이전)은 이 부품들 위에 얹는 장식에 가깝습니다. 이제 정말로, 맵 하나·아군 셋·적 다섯짜리 **자기만의 1챕터 게임**을 완성해볼 시간이에요.
...
**← 이전 글:** [(7/8) 2D SRPG 만들기 선행학습 — Tiled 맵 에디터로 전장 만들기](/coding/SRPG_만들기_선행학습_Tiled_맵에디터/)
