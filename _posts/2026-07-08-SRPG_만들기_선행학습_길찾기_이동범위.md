---
layout: single
title:  "(4/8) 2D SRPG 만들기 선행학습 — 이동 범위와 A* 길찾기"
...
**← 이전 글:** [(3/8) 2D SRPG 만들기 선행학습 — 스프라이트와 애니메이션](/coding/SRPG_만들기_선행학습_스프라이트_애니메이션/) ｜ **다음 글 →:** [(5/8) 2D SRPG 만들기 선행학습 — 턴제 전투와 상태머신](/coding/SRPG_만들기_선행학습_턴제_전투/)
