...
layout: single
title:  "(2/3) LLM Basic"
date: 2024-09-22 21:45:00 +0900
description: "LangChain 기본 사용법을 정리한 글이에요. load_dotenv로 API 키를 관리하고 InMemoryCache로 LLM 호출 비용을 줄이는 법까지 다룹니다."
categories: coding
tag: [llm, langchain, llm basic, teddynote]
author_profile: false
toc: true
header:
  image: /assets/images/2024-09-22-langchain-basic/header.svg
  teaser: /assets/images/2024-09-22-langchain-basic/header.svg
---

{% include series-langchain-intro.html current="2" %}
...
**← 이전 글:** [(1/3) LLM 을 위한 init setting — 환경 셋업](/coding/init_setting/) ｜ **다음 글 →:** [(3/3) Fine Tuning for Data — LLM 파인튜닝 데이터 처리](/coding/01_FineTuning_Data/)
