---
layout: single
title:  "(4/6) 내부문서 RAG 챗봇 — ES 하이브리드 검색과 Redis 3단 게이트"
...
**여기서 50개를 뽑는 게 중요합니다.** [1편 7절](/coding/내부문서_RAG챗봇_아키텍처검증_전체그림/)에서 말한 "1차는 놓치지만 않으면 된다"가 이거예요. [3편의 예시값에서 Recall@50 이 0.968](/coding/내부문서_RAG챗봇_신뢰도게이트_그라운드니스_골든셋/) 이었으니, 정답은 대체로 이 50개 안에 들어와 있습니다.
...
50개를 뽑았지만 순서는 엉망일 수 있어요. [3편의 비교표](/coding/내부문서_RAG챗봇_신뢰도게이트_그라운드니스_골든셋/)에서 Recall@50 은 0.968 인데 MRR@10 은 0.664 였죠. **정답은 들어와 있는데 뒤에 묻혀 있다**는 뜻입니다.
