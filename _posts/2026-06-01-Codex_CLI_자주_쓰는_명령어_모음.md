---
layout: single
title:  "(2/4) Codex CLI 자주 쓰는 명령어 모음 — 서브커맨드부터 슬래시 명령어까지"
...
toc: true
header:
  image: /assets/images/2026-06-01-codex-cli-commands/header.svg
  teaser: /assets/images/2026-06-01-codex-cli-commands/header.svg
---
...
아무것도 안 붙이면 대화형 터미널 UI 가 떠요. 가장 기본 모드예요.
...
격리 컨테이너 안에서 권한을 Full Access 로 올리면 묻지 않고 끝까지 자동 진행해요. 호스트는 안전해요.
...
**← 이전 글:** [(1/4) Claude Code 자주 쓰는 명령어 모음 — CLI 플래그부터 슬래시 명령어까지](/coding/Claude_Code_자주_쓰는_명령어_모음/) ｜ **다음 글 →** [(3/4) Gemini CLI 자주 쓰는 명령어 모음 — 헤드리스 모드와 슬래시 명령어까지](/coding/Gemini_CLI_자주_쓰는_명령어_모음/) 
