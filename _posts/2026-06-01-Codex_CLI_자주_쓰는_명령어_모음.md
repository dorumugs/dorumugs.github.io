---
layout: single
title:  "(2/2) Codex CLI 자주 쓰는 명령어 모음 — 서브커맨드부터 슬래시 명령어까지"
...
일단 오늘은 여기까지.....   
다음 글에서는 두 CLI 에서 공통으로 쓰는 `AGENTS.md` / `CLAUDE.md` 같은 컨텍스트 파일을 어떻게 설계해야 양쪽에서 잘 먹히는지 정리해볼게요.

---

**← 이전 글:** [(1/2) Claude Code 자주 쓰는 명령어 모음 — CLI 플래그부터 슬래시 명령어까지](/coding/Claude_Code_자주_쓰는_명령어_모음/) 
