---
layout: single
title:  "(2/3) 탐지한 개인정보를 안전하게 다루기 — 마스킹, 가역 토큰화, 격리 저장"
...
{% include series-pii-gate.html current="2" %}
...
**← 이전 글:** [(1/3) 들어오는 문서에서 개인정보를 걸러내는 Airflow util](/coding/Airflow_개인정보_탐지_게이트/) ｜ **다음 글 →:** [(3/3) 개인정보 게이트를 스스로 재게 하기 — 라벨·지표·임계값 스윕](/coding/Airflow_개인정보_게이트_평가루프/)
