---
layout: single
title:  "(5/8) 2D SRPG 만들기 선행학습 — 턴제 전투와 상태머신"
...
**← 이전 글:** [(4/8) 2D SRPG 만들기 선행학습 — 이동 범위와 A* 길찾기](/coding/SRPG_만들기_선행학습_길찾기_이동범위/) ｜ **다음 글 →:** [(6/8) 2D SRPG 만들기 선행학습 — 데이터 설계와 세이브/로드](/coding/SRPG_만들기_선행학습_데이터_세이브/)
