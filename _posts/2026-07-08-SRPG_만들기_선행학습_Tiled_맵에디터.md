---
layout: single
title:  "(7/7) 2D SRPG 만들기 선행학습 — Tiled 맵 에디터로 전장 만들기"
...
이것으로 7편의 선행학습이 모두 끝났습니다. 게임 루프에서 시작해 에디터 파이프라인까지 — 파랜드 택틱스 같은 게임의 뼈대를 이루는 부품을 전부 직접 만들어봤어요. 이제 남은 건 6편 로드맵의 나머지(UI·사운드·연출·배포)를 붙이면서 **자기만의 1챕터 게임**을 완성하는 것뿐입니다. 부품은 다 손에 있으니, 조립은 여러분의 몫이에요.
...
**← 이전 글:** [(6/7) 2D SRPG 만들기 선행학습 — 데이터 설계와 세이브/로드](/coding/SRPG_만들기_선행학습_데이터_세이브/)
