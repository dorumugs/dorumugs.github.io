...
date: 2024-11-14 22:00:00 +0900
description: "GitHub를 처음 쓰는 사람을 위한 기본 사용법 정리에요. 작은 커밋 습관, 브랜치 전략, rebase vs merge, Pull Request 활용까지 다룹니다."
categories: coding
tag: [깃헙, Github, commit, branch]
author_profile: false
toc: true
header:
  image: /assets/images/2024-11-14-github-basics/header.svg
  teaser: /assets/images/2024-11-14-github-basics/header.svg
---
...
3. **작성자 정보**
   커밋 작성자의 이름과 이메일 주소가 표시됩니다. 예를 들어, `Author: Kayser So <dorumugs@gmail.com>`는 작성자가 Kayser So이며, 이메일이 `dorumugs@gmail.com`임을 보여줍니다.
4. **날짜와 시간**
