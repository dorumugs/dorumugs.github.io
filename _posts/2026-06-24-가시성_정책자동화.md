---
layout: single
title:  "(4/5) 가시성·정책 자동화 — 흐름을 관찰하고 정책을 코드로 굴리기"
...
**← 이전 글:** [(3/5) 마이크로세그멘테이션 실전 — 트래픽 흐름 위에 default-deny 그리기](/coding/마이크로세그멘테이션_실전/) ｜ **다음 글 →:** [(5/5) 멀티 클라우드로 넓히기 — 클라우드가 여럿일 때 깨지는 것들](/coding/멀티클라우드_금융보안/)
