---
layout: single
title:  "(3/4) 마이크로세그멘테이션 실전 — 트래픽 흐름 위에 default-deny 그리기"
...
**← 이전 글:** [(2/4) 제로트러스트 설계 — 망분리 다음의 금융보안을 구성요소로 뜯어보기](/coding/제로트러스트_설계_금융보안/) ｜ **다음 글 →:** [(4/4) 가시성·정책 자동화 — 흐름을 관찰하고 정책을 코드로 굴리기](/coding/가시성_정책자동화/)
