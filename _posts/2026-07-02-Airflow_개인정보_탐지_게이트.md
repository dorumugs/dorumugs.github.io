---
layout: single
title:  "(1/3) 들어오는 문서에서 개인정보를 걸러내는 Airflow util — 넓게 잡고, 확실히 거른다"
...
series: pii-gate
series_order: 1
series_title: "🔐 문서 속 개인정보, 탐지부터 평가까지"
---

{% include series-pii-gate.html current="1" %}
...
**다음 글 →:** [(2/3) 탐지한 개인정보를 안전하게 다루기 — 마스킹, 가역 토큰화, 격리 저장](/coding/Airflow_개인정보_마스킹_격리저장/) 
