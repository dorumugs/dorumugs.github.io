---
layout: single
title:  "(6/10) 2D SRPG 만들기 선행학습 — 데이터 설계와 세이브/로드"
...
3. **사운드** — `pygame.mixer` 로 BGM 과 효과음. 타격음 하나만 넣어도 게임의 체감이 확 달라져요. **9편**에서 다룹니다.
4. **연출** — 데미지 숫자 팝업, 화면 흔들림, 페이드 전환. 전부 델타타임 응용입니다. **10편**에서 다룹니다.
...
**← 이전 글:** [(5/10) 2D SRPG 만들기 선행학습 — 턴제 전투와 상태머신](/coding/SRPG_만들기_선행학습_턴제_전투/) ｜ **다음 글 →:** [(7/10) 2D SRPG 만들기 선행학습 — Tiled 맵 에디터로 전장 만들기](/coding/SRPG_만들기_선행학습_Tiled_맵에디터/)
