---
layout: single
title:  "(6/7) 2D SRPG 만들기 선행학습 — 데이터 설계와 세이브/로드"
...
2. **UI 와 메뉴** — 유닛 정보창, 행동 메뉴, 전투 예측창. 5편의 상태머신에 상태를 추가하는 연습으로 최적입니다.
...
**← 이전 글:** [(5/7) 2D SRPG 만들기 선행학습 — 턴제 전투와 상태머신](/coding/SRPG_만들기_선행학습_턴제_전투/) ｜ **다음 글 →:** [(7/7) 2D SRPG 만들기 선행학습 — Tiled 맵 에디터로 전장 만들기](/coding/SRPG_만들기_선행학습_Tiled_맵에디터/)
